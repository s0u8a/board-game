        ...
        <section class="new-games">
            <div class="container">
                ...
                <div class="games-grid">
                    <div class="game-card"><img src="images/game-1.png" alt="Game 1" onerror="this.src='https://placehold.co/300x200?text=Game+1'"></div>
                    <div class="game-card"><img src="images/game-2.png" alt="Game 2" onerror="this.src='https://placehold.co/300x200?text=Game+2'"></div>
                    <div class="game-card"><img src="images/game-3.png" alt="Game 3" onerror="this.src='https://placehold.co/300x200?text=Game+3'"></div>
                    <div class="game-card"><img src="images/game-4.png" alt="Game 4" onerror="this.src='https://placehold.co/300x200?text=Game+4'"></div>
                </div>
